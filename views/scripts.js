...
// const ProjectProgressID = document.getElementById("ProjectProgressID")

// getProjectBtn.addEventListener("click",()=>{
  
//   console.log(progressTable.value);
// })
...
// function addTableRow1(user,table) {
//   let values = Object.values(user);
//   let row = document.createElement("tr");
//   row.classList.add("table-row");
...
// function fillTable1(data,table) {
//   for (let user of data) {
//     addTableRow1(user,table);
//   }
// }
